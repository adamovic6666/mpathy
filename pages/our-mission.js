...
const ourMission = () => (
  <>
    <Hero
      ...
      description="<p>A whole young generation is in deep trouble with mental health problems. Millions are suffering from depression, eating disorders, self-harm, bullying, body-shaming and every form of toxic influence. Tragically, in the worst cases, we’re losing many young, promising lives to suicide.</p><p>
